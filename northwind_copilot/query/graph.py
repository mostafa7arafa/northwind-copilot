...
def build_agent() -> CompiledStateGraph:
    ...
    # The fallback is optional: with no OPENAI_API_KEY, build_fallback_model
    # returns None and the escalation middleware simply has no target to try.
    ...
    return create_agent(
        ...
        checkpointer=None,
        middleware=[
            EscalateToFallbackMiddleware(*fallbacks),
            trim_context,
        ],
    )
